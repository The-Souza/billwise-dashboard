...
export function RevenueExpenseChart({
  ...
  return (
    <Card className="lg:col-span-3">
      ...
      <CardContent>
        {isLoading ? (
          <Skeleton className="min-h-66 w-full rounded-lg" />
        ) : chartData.length === 0 ? (
          <div className="min-h-66 w-full flex flex-col items-center justify-center gap-2 text-muted-foreground">
          ...
          <ChartContainer
            config={chartConfig}
            className="min-h-56 max-h-66 w-full"
          >
